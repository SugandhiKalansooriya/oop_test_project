...
.btn-block { width: 60%; display:block;margin-left:40px }
...
.del h1 { color: #fff; text-shadow: 0 0 10px rgba(0,0,0,0.3); letter-spacing:1px; text-align:left-align; }
.del td{ color: #fff;text-align:left-align; }
table{
margin-left:40px;
...
<table>
	...
	<br>
	<input type="submit" name="submit" value="Delete My Account" class="btn btn-primary btn-block btn-large">
	</form>
</div>
